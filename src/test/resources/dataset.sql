...
insert into paciente values('18635123', 1, 1,'Carlos Lopez', '4564545', 'url_foto', 'Sinalergias', 1, 1, '1995-11-28', 2);
insert into paciente values('42574652', 1, 1,'David Santiago', '2222222', 'url_foto', 'Alergico al polen',1, 1, '2000-12-5', 3);
insert into paciente values('58423654', 1, 1,'Johan Stiven', '8585835', 'url_foto', 'Alergia acetaminofen', 1, 2, '2001-05-16', 4);
insert into paciente values('45485654', 1, 1,'Jose Fernando', '54545856', 'url_foto', 'sin alergias', 1, 2, '1998-10-25',5);

insert into Medico values('254875324', 1, 1, 'Juan David', '3257486512', 'url_foto', 1, 6 );
